...
public class BlockCeilingPanel extends Block
{
    public BlockCeilingPanel(int par1)
    {
    ...
    {
        float f = 15.0F / 16.0F;
        this.setBlockBounds(0.0F, f, 0.0F, 1.0F, 1.0f, 1.0F);
    }
    ...
    {
        return par5 == 0 ? true : super.shouldSideBeRendered(par1IBlockAccess, par2, par3, par4, par5);
    }
