...
public class GuiWoodGen extends GuiContainer
{
    private static final ResourceLocation field_110410_t = new ResourceLocation("misctweaks:textures/gui/woodGen.png");
    private TileEntityWoodGenerator furnaceInventory;

    public GuiWoodGen(InventoryPlayer player, TileEntityWoodGenerator furnace)
    {
        super(new ContainerWoodGenerator(player, furnace));
