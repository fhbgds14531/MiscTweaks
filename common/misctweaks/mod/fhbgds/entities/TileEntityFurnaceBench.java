...
public class TileEntityFurnaceBench extends TileEntity implements ISidedInventory
{
    ...
    {
        return this.isInvNameLocalized() ? this.field_94130_e : "container.furnaceBench";
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockFurnaceBench.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
