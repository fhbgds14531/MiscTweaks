...
public class ContainerMyFurnace extends Container{
    private TileEntityMyFurnace furnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerMyFurnace(InventoryPlayer par1InventoryPlayer, TileEntityMyFurnace par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new SlotMyFurnace(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
        this.addSlotToContainer(new SlotMyFurnace(par1InventoryPlayer.player, par2TileEntityFurnace, 3, 140, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int invSlot)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                    if (MyFurnaceRecipes.smelting().getSmeltingResult(itemstack1) != null)
                    {
                    ...
                    else if (TileEntityMyFurnace.isItemFuel(itemstack1))
                    {
